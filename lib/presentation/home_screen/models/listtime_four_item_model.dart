...
class ListtimeFourItemModel {
  ...
  Rx<String> meetEndTime = Rx('Lorem ipsum dolor sit amet');
  Rx<String> meetTime = Rx('Lorem ipsum dolor sit amet');
  Rx<String> meetContacts = Rx('Lorem ipsum dolor sit amet');
}
